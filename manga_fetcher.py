...
class MangaDexFetcher:
    ...
    def get_manga_id(self, title: str) -> Optional[str]:
        ...
        try:
            ...
            if data.get("result") == "ok" and data.get("data"):
                ...
                found_title = titles.get("en") or titles.get(list(titles.keys())[0] if titles else "")
    ...
    def get_volume_covers(self, manga_id: str, volume_numbers: Set[int]) -> Dict[int, str]:
        """
        ...
        try:
            ...
            if data.get("result") == "ok" and data.get("data"):
                ...
                if missing:
                    print(f"Warning: Could not find covers for volumes: {sorted(missing)}")
